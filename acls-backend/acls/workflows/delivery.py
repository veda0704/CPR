...
DELIVERY_WORKFLOW = {
    ...
    "delivery_mechanics_1": {
        ...
        "choices": [
            ...
            {"label": _("BACK"), "next": "delivery_stage_1", "color": "secondary"}
        ]
    },
    "delivery_mechanics_2": {
        ...
        "video": "/static/images/birth_descent.png",
        "choices": [
    ...
    "delivery_mechanics_3": {
        ...
        "video": "/static/images/birth_shoulder.png",
        "choices": [
    ...
    "delivery_stage_3": {
        ...
        "video": "/static/images/birth_placenta.png",
        "choices": [
            {"label": _("FINISH"), "next": "delivery_complete", "color": "success"}
        ]
    },
    "delivery_complete": {
        "title": _("Delivery Complete"),
        "question": _("Labour, Delivery, and Neonatal stabilization review complete. Would you like to review the ABCDE systematic approach for the mother next?"),
        "video": "/static/images/abcde_start.png",
        "choices": [
    ...
    "nls_start": {
        ...
        "choices": [
            {"label": _("YES (STAY WITH MOTHER)"), "next": "delivery_stage_3", "color": "success"},
    ...
    "nls_cyanosis": {
        ...
        "choices": [
            {"label": _("YES"), "next": "delivery_stage_3", "color": "success"}
        ]
    },
    "nls_ppv": {
        ...
        "choices": [
            {"label": _("HR IS NORMAL"), "next": "delivery_stage_3", "color": "success"},
    ...
    "nls_compressions": {
        ...
        "video": "/static/images/nls_resuscitation.png",
        "choices": [
    ...
    "nls_drugs": {
        ...
        "choices": [
            {"label": _("FINISH"), "next": "delivery_stage_3", "color": "success"}
        ]
    }
}
